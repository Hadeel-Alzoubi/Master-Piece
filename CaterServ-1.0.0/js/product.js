      ...
      `  <div class="col-lg-3 col-md-6 wow bounceInUp" data-wow-delay="0.1s">
              <div class="team-item rounded">
                  ...
                  <div class="team-content text-center py-3 bg-dark rounded-bottom">
                   ...
                   <a class="" href="#" onclick="ProductDetails(${element.productId}); return false;">تفاصيل المنتج</a>
                  </div>
                  <div class="team-icon d-flex flex-column justify-content-center m-4">
                      ...
                      <a class="share-link btn btn-primary btn-md-square rounded-circle mb-2" href="#" onclick="store(${element.productId}); return false;"><i class="fa fa-info"></i></a>
                  </div>
              </div>
          </div>`;
  });
